...
public class Brain {
    ...
    4 neurones en sorties
     */
    public Brain() {
        this.weight_i = new Array2DRowRealMatrix(10,8);
        this.weight_ih = new Array2DRowRealMatrix(8,10);
        this.weight_hh= new Array2DRowRealMatrix(6,8);
        this.weight_ho = new Array2DRowRealMatrix(4,6);
        ...
        this.bias_ho = new Array2DRowRealMatrix(4,1);
    ...
    void train(Array2DRowRealMatrix input, Array2DRowRealMatrix target, double learningRate){
        ...
        Array2DRowRealMatrix temp_error_ho = new Array2DRowRealMatrix(4,1);
        for (int i = 0; i < 4 ; i++){
            double total = 0.0;
            for (int j = 0; j < 6; j++){
